...
-   Verify sensor temperatures using diagnostics inside [**Hardware Monitoring**](/Tools/Apps/Hardware/).
...
-   Consult the [**Web Browsers Guide**](/Tools/Apps/Browsers/) to choose privacy-respecting navigation software.
